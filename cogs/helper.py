...
class SeiyuuSearch():
    ...
    @commands.command(name = "helpdesk", description = "Automated Self-serve Help Center")
    async def helpdesk(self, ctx):
        await ctx.send("Welcome to the THE iDOLM@STER: Million Live! Theater Days Self-Service Center, " + ctx.author.mention + "\n"
            "Please choose one of the following options or type '39' to end.\n"
            "1:Theater Days Support - Help with the Theater Days mobile game, including basic beginner questions, menu translations, game F.A.Q., etc.\n"
